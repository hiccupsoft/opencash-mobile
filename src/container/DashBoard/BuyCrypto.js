...
function BuyCrypto(props) {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            ...
            headerTitle: () => <HeaderTitleText titleName={'BTC - $497.50'} value={'$1,000.34 available'} />,
        });
    }, [navigation]);
    ...
    return (
        <View style={AuthStyles.authContainer}>
            <View style={[SpaceStyles.spaceHorizontal, SpaceStyles.top9]}>
                ...
                <CustomText
                    text={'You are placing a market order to buy 5 BTC. Your order will be executed during regular market hours.'}
                    style={[TextStyles.textMedium15DarkBlack, , SpaceStyles.top3]}
                />
                <CustomText
                    text={'You are placing a limit order to buy 5 BTC at $497.50. Good-til-cancel limit orders will remain open until canceled or for 90 days.'}
