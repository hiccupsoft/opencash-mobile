        ...
        <View style={AuthStyles.authContainer}>
            ...
            <View style={SpaceStyles.spaceHorizontal}>
                <View style={SpaceStyles.row}>
                    <Image source={hand} resizeMode='contain' style={AuthStyles.imageHand} />
                    <View style={[SpaceStyles.leftMargin, AuthStyles.textView]}>
                        ...
                        <CustomText
                            ...
                            style={[TextStyles.textRegular14, SpaceStyles.vertical1]}
                        />
                    </View>
                </View>
                <View style={SpaceStyles.row}>
                    <Image source={percent} resizeMode='contain' style={AuthStyles.imagePercent} />
                    <View style={[SpaceStyles.leftMargin, AuthStyles.textView]}>
                        <CustomText
                        ...
                        />
                        <CustomText
                            text={'Get access to cash or stablecoins in minutes with an Opencash credit line.'}
                            style={[TextStyles.textRegular14, SpaceStyles.vertical1]}
                        />
                    </View>
                </View>
